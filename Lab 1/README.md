...
![sketch](Documentation/sketch1-3.png)
...
**Exploration of design space/Novelty of Concept**: "_These ideas are useful for people's health. For example, in scenario 3, the device would notify people to drink water, which is useful for people who are very busy on their work. Apart from that, they also came up with ideas that the device can detect the water temperature, which can prevent people from getting scalded. These ideas are creative and useful for ppl._"

**Technical execution**: "_Good technical execution! If it can perform more scenario, it would be better, such as changing to other colors._"

**Communication of idea/documentation of process**: "_The document conveyed clear ideas and prototypes, and it is easy to read and understand. Good job!_", "_Really liked the idea of changing color for bottles containing water with hard metals or salts. Definitely could be useful in a place like NYC :)_"

**Tested with user**: "_They provided a lot of feedbacks from other students. Also, they reflected their ideas and elaborated their opportunities and concerns very well._"
...
After Part 1 and gathering feedback from other groups, we wanted to expand and contextualize the scenarios where the bottle would be most useful. Fitness stood out as a natural setting, since people often carry and use water bottles during workouts. We further narrowed down, chose yoga as a key scenario and framed the question: **How might we integrate the bottle into the yoga and meditation routine to enhance the user experience?**

From this, we developed the idea of a smart mat × bottle combination, where the bottle could be embedded directly into the yoga mat. We then brainstormed three scenarios that extended the bottle’s original lighting function while adding vibration and sound features to enrich the interaction.

**Settings**: The initial setting can be anywhere the user carries the bottle. The bottle reminds the user to begin their yoga routine, leading to the next interaction in a home or fitness center practice area, during the user’s regular yoga and meditation sessions. It could take place both in moments of quiet focus and in situations where external interruptions (like phone timers or workout ads) might normally break the flow.

**Players**: 
Primary Player: The individual who needs to be reminded to practice yoga and meditation, seeking focus and relaxation.
Secondary Players (not directly involved in interaction): Potential bystanders such as housemates, family members, or fellow gym members who may notice the mat’s glowing light.

**Activity**: The user is reminded to start their workout session when the bottle begins to glow. They carry the bottle, unroll the smart yoga mat, insert the bottle into the mat, and play music and guidance. The mat glows softly in tune with the rhythm and mood, provides gentle instructional prompts, and ends the session with a calm countdown sound, followed by a soft vibration, allowing the user to remain fully immersed in their flow.

**Goal**: (1) To be reminded with their workout routine. (2) To achieve uninterrupted focus and flow during yoga and meditation, enhancing both physical practice and mental relaxation, while creating a supportive, calming, and intuitive environment that reduces reliance on disruptive external devices.

### Scenario 1: Remind people their daily fitness routine
![b-scene1](Storyboards/b-scene1.png)

_(Images generated by ChatGPT-5)_

### Scenario 2: Glow with the music rhythm
![b-scene2](Storyboards/b-scene2.png)

_(Images generated by ChatGPT-5)_

### Scenario 3: Count down with vibration to end the yoga session
![b-scene1](Storyboards/b-scene3.png)
...
**Bottle Costume**
<p align="center">
  <img src="Documentation/b-costume1.jpg" alt="Bottle Costume" width="400"/>
  <img src="Documentation/b-costume2.jpg" alt="Bottle Costume" width="400"/>
</p>

Here is our sketch of the **Smart Mat x Bottle**
<p align="center">
  <img src="Documentation/b-sketch.jpg" alt="Sketch of Smart Bottle × Yoga Mat" width="600"/>
</p>  
...
Prototyped interaction of the Smart Mat × Bottle: https://youtu.be/y5ejHxZTvZc
- Actress: Jully Li
- Director: Sirui Wang
- Narrative: Amy Chen
